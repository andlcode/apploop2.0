...
const LooperPageContent = () => {
  const { selectedRitmo, currentAudio, isScheduled, currentBeat } = useLoopManager();
  ...
  const isPlaying = !!currentAudio || isScheduled;
  ...
  return (
    <>
      ...
      <div className="min-h-screen flex flex-col bg-background relative selection:bg-primary/30">
        ...
        {/* Real-time Beat Indicator below the header */}
        <div className="relative z-20 px-4 pt-2 pb-4">
        ...
        <main className="flex-1 overflow-y-auto relative z-10 custom-scrollbar">
          <div className="max-w-7xl mx-auto px-4 pb-8 md:pb-12">
            ...
            {/* Components are ALWAYS rendered, avoiding flicker */}
